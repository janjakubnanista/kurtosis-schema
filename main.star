...
_string_module = import_module("/src/types/string.star")
_struct_module = import_module("/src/types/struct.star")
...
string_type = _string_module.create
struct_type = _struct_module.create
